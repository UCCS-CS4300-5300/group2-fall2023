...
class UtilsTests(TestCase):
    def test_get_coordinates_success(self):
        ...
        with patch("googlemaps.Client.geocode") as mock_geocode:
            mock_geocode.return_value = [{"geometry": {"location": {"lat": 38.8966, "lng": -104.8049}}}]

            result = utils.get_coordinates(settings.GOOGLE_MAPS_API_KEY, "1420 Austin Bluffs Pkwy, Colorado Springs, CO 80918, USA")
